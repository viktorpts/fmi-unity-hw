...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class ThirdPersonCharacter : MonoBehaviour
    {
        ...
        void UpdateAnimator(Vector3 move, bool action)
        {
            if (action)
            {
                m_Animator.SetFloat("Action", action ? 1f : 0f, 0.1f, Time.deltaTime);
        ...
        void HandleGroundedMovement(bool crouch, bool jump, bool action)
        {
            ...
            if (jump && !crouch && !action && m_Animator.GetCurrentAnimatorStateInfo(0).IsName("Grounded"))
            {
                // jump!
